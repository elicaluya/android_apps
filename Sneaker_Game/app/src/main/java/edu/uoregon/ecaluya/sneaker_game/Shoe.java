...
public class Shoe {
    ...
    public String[] jordan_colorways = {"Black Toe","Blue Moon","Bred","Bred Toe","Clay Green","New Love","Royal","Chicago","Fragment","Gold Top 3",
            "Off-White Chicago","Off-White UNC","Off-White White","Shattered Backboard","Shadow","Track Red","Yellow Ochre","Just Don(Arctic Orange)",
            "Just Don(Beach)","Just Don(Blue)","Black Cement","Cactus Jack","Tinker","True Blue","Katrina","Grateful","Seoul","Oregon","KAWS",
            "Levi's Black","Levi's Denim","Levi's White","Military Blue","White Cement","Bel Air","Black Grape","Black Metallic","Fire Red","Grape",
            "Raging Bull Red Suede","Black Infrared","Laney","Oreo","Supreme(Desert Camo)","Tokyo","Gatorade Green","Like Mike","White Infrared",
            "Bordeaux","Olympic","Hare","Aqua","Bugs Bunny","Cap and Gown","Cool Grey","Columbia","Concord","Space Jam","Win Like 82","Win Like 96",
            "Cherry","UNC","Flu Game","French Blue","Taxi","Black Cat","Chutney","Ferrari","Last Shot"};


    public String[] nike_models = {"Air Force 1 Low","Air Mag","Air Presto","Air Presto Mid","Air Zoom Generation","Air Max 1","Air Max 270","Air Max 90",
            "Air Max 95","Air Max 97","Air Max 1/97","Air Max 97/BW","Air Max 98","Air More Uptempo","Blazer Mid","Dunk High","Dunk Low","Flyknit Racer","Foamposite One",
            "Air Huarache","Hyperdunk Flyknit","KD 4","KD 6","Kobe 1 Protro","Kobe 9","Kobe 10","Kobe 11", "Lebron 8","Lebron 9","Lebron 9 Low","Lebron 11",
            "Lebron 12","Lebron 15","React Element 87","Vapormax","Air Yeezy 1","Air Yeezy 2","Zoom Fly"};
    public String[] nike_colorways = {"Playstation","Sean Wotherspoon","Metallic Gold","Off-White","Curry","Parra","Dusty Cactus","We Love Nike","Back to the Future",
            "Lightning","Unholy Cumulus","Acronym","Air Max Day","Atmos","University Red",
            "Master","Safari","Duck Camo","Japan Camo","USA(Red)","Moon Landing","Warhawk","First Game","Infrared",
            "Neon","Silver Bullet","Skepta","Gundam","Bulls","De La Soul","Supreme(Blue)","Skunk","Tiffany","What The","Cali",
            "Heineken","Paris","Pigeon","Pink Box",
            "Supreme(Red)","Be True","Multicolor","Big Bang","Eggplant","Galaxy","Royal Blue","Wu-Tang","Hyperpunch",
            "Aunt Pearl","Close Out","Undefeated Camo","Fade to Black","Beethoven","Shark Jaw","South Beach","Lebronald Palmer","2K14","King's Cloak",
            "Orange Box","Mowabb","Sail","Asphalt","Triple Black","Net","Red October"};
    ...
    Shoe(int id){
        ...
        else if (id == R.drawable.aj1_bluemoon){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 1";
            colorway = "Blue Moon";
        ...
        else if (id == R.drawable.aj1_bredtoe){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 1";
            colorway = "Bred Toe";
        }
        else if (id == R.drawable.aj1_claygreen){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 1";
            colorway = "Clay Green";
        ...
        else if (id == R.drawable.aj1_fragment){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 1";
            colorway = "Fragment";
        ...
        else if (id == R.drawable.aj1_offwhtchi){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 1";
            colorway = "Off-White Chicago";
        }
        else if (id == R.drawable.aj1_offwhtunc){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 1";
            colorway = "Off-White UNC";
        }
        else if (id == R.drawable.aj1_offwhtwht){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 1";
            colorway = "Off-White White";
        }
        ...
        else if (id == R.drawable.aj1_trackred){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 1";
            colorway = "Track Red";
        }
        else if (id == R.drawable.aj1_yellowochre){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 1";
        ...
        else if (id == R.drawable.aj3_katrina){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 3";
            colorway = "Katrina";
        ...
        else if (id == R.drawable.aj3_seoul){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 3";
            colorway = "Seoul";
        }
        else if (id == R.drawable.aj3_tinker){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 3";
            colorway = "Tinker";
        ...
        else if (id == R.drawable.aj4_cactusjack){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 4";
        ...
        else if (id == R.drawable.aj4_levisblack){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 4";
            colorway = "Levi's Black";
        }
        else if (id == R.drawable.aj4_levisdenim){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 4";
            colorway = "Levi's Denim";
        }
        else if (id == R.drawable.aj4_leviswht){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 4";
            colorway = "Levi's White";
        }
        ...
        else if (id == R.drawable.aj6_gatorade){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 6";
            colorway = "Gatorade Green";
        }
        else if (id == R.drawable.aj6_likemike){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 6";
            colorway = "Like Mike";
        ...
        else if (id == R.drawable.aj11_capngown){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 11";
            colorway = "Cap and Gown";
        }
        ...
        else if (id == R.drawable.aj11_winlike82){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 11";
        ...
        else if (id == R.drawable.aj11lo_unc){
            this.id = id;
            brand = "Jordan";
            model = "Air Jordan 11 Low";
            colorway = "UNC";
        ...
        else if (id == R.drawable.nike_af1lo_playstation){
            this.id = id;
            brand = "Nike";
            model = "Air Force 1 Low";
            colorway = "Playstation";
        }
        ...
        else if (id == R.drawable.nike_am1_curry){
            this.id = id;
            brand = "Nike";
            model = "Air Max 1";
            colorway = "Curry";
        ...
        else if (id == R.drawable.nike_am1_parra){
            this.id = id;
            brand = "Nike";
            model = "Air Max 1";
            colorway = "Parra";
        ...
        else if (id == R.drawable.nike_am1_welovenike){
            this.id = id;
            brand = "Nike";
            model = "Air Max 1";
            colorway = "We Love Nike";
        }
        else if (id == R.drawable.nike_am197_wotherspoon){
            this.id = id;
            brand = "Nike";
            model = "Air Max 1/97";
            colorway = "Sean Wotherspoon";
        }
        else if (id == R.drawable.nike_am270_betrue){
            this.id = id;
            brand = "Nike";
            model = "Air Max 270";
            colorway = "Be True";
        }
        else if (id == R.drawable.nike_am270_dustycactus){
            this.id = id;
            brand = "Nike";
            model = "Air Max 270";
            colorway = "Dusty Cactus";
        }
        ...
        else if (id == R.drawable.nike_am90_welovenike){
            this.id = id;
            brand = "Nike";
            model = "Air Max 90";
            colorway = "We Love Nike";
        ...
        else if (id == R.drawable.nike_am95_welovenike){
            this.id = id;
            brand = "Nike";
            model = "Air Max 95";
            colorway = "We Love Nike";
        }
        else if (id == R.drawable.nike_am97_metallicgold){
            this.id = id;
            brand = "Nike";
            model = "Air Max 97";
        ...
        else if (id == R.drawable.nike_am97bw_skepta){
            this.id = id;
            brand = "Nike";
            model = "Air Max 97/BW";
            colorway = "Skepta";
        }
        else if (id == R.drawable.nike_am98_gundam){
            this.id = id;
            brand = "Nike";
            model = "Air Max 98";
            colorway = "Gundam";
        }
        else if (id == R.drawable.nike_am98_southbeach){
            this.id = id;
            brand = "Nike";
            model = "Air Max 98";
        ...
        else if (id == R.drawable.nike_foam_bigbang){
            this.id = id;
            brand = "Nike";
        ...
        else if (id == R.drawable.nike_kobe1protro_closeout){
            this.id = id;
            brand = "Nike";
            model = "Kobe 1 Protro";
            colorway = "Close Out";
        }
        else if (id == R.drawable.nike_kobe1protro_undftd){
            this.id = id;
            brand = "Nike";
            model = "Kobe 1 Protro";
            colorway = "Undefeated Camo";
        }
        ...
        else if (id == R.drawable.nike_lebron15_kingscloack){
            this.id = id;
            brand = "Nike";
            model = "Lebron 15";
            colorway = "King's Cloak";
        }
        else if (id == R.drawable.nike_lebron15_mowabb){
            this.id = id;
            brand = "Nike";
            model = "Lebron 15";
            colorway = "Mowabb";
        }
        else if (id == R.drawable.nike_lebron15_orangebox){
            this.id = id;
            brand = "Nike";
            model = "Lebron 15";
            colorway = "Orange Box";
        }
        else if (id == R.drawable.nike_reactelement87_sail){
            this.id = id;
            brand = "Nike";
