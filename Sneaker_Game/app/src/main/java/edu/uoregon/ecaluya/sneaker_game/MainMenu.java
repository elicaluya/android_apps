...
public class MainMenu extends AppCompatActivity implements View.OnClickListener {
    ...
    int[] adidasShoes = {R.drawable.adidas_alphabounce_rc,R.drawable.adidas_dame3_roots,R.drawable.adidas_iniki_blkgum,R.drawable.adidas_nmdhmnrace_ff,
            R.drawable.adidas_nmdhmnrace_tangerine,R.drawable.adidas_nmdr1_datamosh,R.drawable.adidas_nmdr1_linen,R.drawable.adidas_nmdr1_og,
            R.drawable.adidas_nmdr1_solar,R.drawable.adidas_nmdr1_stripes,R.drawable.adidas_nmdr2_cargogreen,R.drawable.adidas_ub1_tw,
            R.drawable.adidas_ub2_3m,R.drawable.adidas_ub2_multi, R.drawable.adidas_ub2_rc, R.drawable.adidas_ub2_wood,R.drawable.adidas_ub3_bronze,
            R.drawable.adidas_ub3_tb,R.drawable.adidas_ub3_kolor,R.drawable.adidas_ub3_pride,R.drawable.adidas_ub3_cny, R.drawable.adidas_ub3_oreo,
            R.drawable.adidas_yzy350_moonrock, R.drawable.adidas_yzy350_oxfordtan,R.drawable.adidas_yzy350_pb, R.drawable.adidas_yzy350_td,
            R.drawable.adidas_yzy350v2_beluga,R.drawable.adidas_yzy350v2_blkgreen,R.drawable.adidas_yzy350v2_blkinfrared,R.drawable.adidas_yzy350v2_bred,
            ...
            R.drawable.adidas_yzy750_grey,R.drawable.adidas_yzy750_gum,R.drawable.adidas_yzypowerphase_calabasas};

    int[] jordanShoes = {R.drawable.aj1_blktoe,R.drawable.aj1_bred,R.drawable.aj1_chicago,R.drawable.aj1_royal,R.drawable.aj2_chicago,R.drawable.aj3_bc,
            ...
            R.drawable.aj5_laney,R.drawable.aj5_supremedc,R.drawable.aj6_blackinfrared,R.drawable.aj6_carmine,R.drawable.aj6_white_infrared,R.drawable.aj7_olympic,
            R.drawable.aj7_bordeaux,R.drawable.aj8_aqua,R.drawable.aj8_bugsbunny,R.drawable.aj9_coolgrey,R.drawable.aj10_chicago,
            R.drawable.aj11_bred,R.drawable.aj11_concord,R.drawable.aj11_lgndblu,R.drawable.aj11_spacejam,R.drawable.aj11lo_cherry,R.drawable.aj12_flugame,
            R.drawable.aj12_fb,R.drawable.aj12_taxi,R.drawable.aj13_bred,R.drawable.aj14_blktoe,R.drawable.aj14_ferrari,R.drawable.aj14_lastshot};

    int[] nikeShoes = {R.drawable.nike_huarache_hyperpunch,R.drawable.nike_airprestomid_acronym,R.drawable.nike_airzg_1stgame,R.drawable.nike_am1_atmos,R.drawable.nike_am1_univred,R.drawable.nike_am90_duckcamo,
            R.drawable.nike_am90_infrared,R.drawable.nike_am90_moonland,R.drawable.nike_am90_warhawk,R.drawable.nike_am95_neon,R.drawable.nike_am97_silvrbullet,
            R.drawable.nike_amu_bulls,R.drawable.nike_dunkhi_dls,R.drawable.nike_dunkhi_supremeblue,R.drawable.nike_dunkhi_whatthe,
            ...
            R.drawable.nike_foam_eggplant,R.drawable.nike_kd4_galaxy,R.drawable.nike_kd6_auntpearl,
            R.drawable.nike_kobe9_beethoven,R.drawable.nike_kobe10_sharkjaw,R.drawable.nike_kobe11_ftb,R.drawable.nike_lebron8_sb,R.drawable.nike_lebron9_galaxy,
