...
public class MainMenu extends AppCompatActivity implements View.OnClickListener {
    ...
    int[] adidasShoes = {R.drawable.adidas_alphabounce_rc,R.drawable.adidas_dame3_roots,R.drawable.adidas_iniki_blkgum,R.drawable.adidas_js_batman,
            ...
            R.drawable.adidas_nmdr2_cargogreen,R.drawable.adidas_ub1_tw,R.drawable.adidas_ub2_3m,R.drawable.adidas_ub2_multi,
            ...
            R.drawable.adidas_ub3_pride,R.drawable.adidas_ub3_cny, R.drawable.adidas_ub3_oreo,R.drawable.adidas_yzy350_moonrock,
    ...
    int[] nikeShoes = {R.drawable.nike_airmag_bttf,R.drawable.nike_airpresto_lightning,R.drawable.nike_airpresto_uncumulus,
            R.drawable.nike_huarache_hyperpunch,R.drawable.nike_airprestomid_acronym,R.drawable.nike_airzg_1stgame,R.drawable.nike_am1_atmos,
            R.drawable.nike_am1_univred,R.drawable.nike_am90_duckcamo,R.drawable.nike_am90_infrared,R.drawable.nike_am90_moonland,
            R.drawable.nike_am90_warhawk,R.drawable.nike_am95_neon,R.drawable.nike_am97_silvrbullet,
            R.drawable.nike_amu_bulls,R.drawable.nike_dunkhi_dls,R.drawable.nike_dunkhi_skunk,R.drawable.nike_dunkhi_supremeblue,R.drawable.nike_dunkhi_whatthe,
            ...
            R.drawable.nike_dunklo_pinkbox,R.drawable.nike_dunklo_supremered,R.drawable.nike_flyrcr_betrue,R.drawable.nike_flyrcr_multi,R.drawable.nike_foam_galaxy,R.drawable.nike_foam_royal,
